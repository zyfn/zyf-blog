...
- 文章 H1 使用 `clamp(3rem, 5vw, 4.5rem)` 的响应式范围，桌面端不超过约 72px，字重以 480–520 为基准；不要使用超大展示字号、过粗字重或过紧中文字符间距。
- 正文以 18–19px、400 字重、约 1.65 行高为基准，阅读列约 680–740px；H2 约 32–40px，H3 约 23–26px，标题字重控制在 520–580。代码继续使用等宽字体。
